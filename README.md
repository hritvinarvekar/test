...
<div align="center">
  <p align="center">
    <img src="kuro.png" alt="Kuro CLI Banner" width="80%" />
  </p>
...
<!-- ABOUT THE PROJECT -->
<h4 id="about-the-project">🧠  About The Project: </h4> <hr> Kuro is a command line interface powered by AI that listens to your commands and uses Google's Gemini AI to execute them.
<ul>
...
<p align="right">(<a href="#readme-top">back to top</a>)</p> 
<!-- GETTING STARTED -->
<h4 id="getting-started"> 🚀  Getting Started:  </h4> <hr>
To run Kuro locally.
<br>
<h4>📋 Prerequisites: </h4>  
<ul>
